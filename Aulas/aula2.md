...
O termo projeto colaborativo surge para nosso contexto da construção civil a partir da consideração das possibilidades de comunicação abertas pelas tecnologias digitais e, especialmente a internet, **a capacidade de compartilhamento de modelos ou arquivos digitais através de uma grande variedade de ferramentas.**

```
A colaboração acontece em todos os campos
```


Thomas Kvan escreve em seu texto [Collaborative Design: What is it?](https://www.sciencedirect.com/science/article/abs/pii/S0926580599000254) sobre colaboração em projeto, sugerindo uma tendência de que este termo estaria diretamente associado a sistemas colaborativos que permitem comunicação a distância entre projetistas de uma mesma ou de diversas especialidades.

Thomas ainda fala que

```
A colaboração pode ser pensada como uma solução conjunta de problemas. 
Significa trabalhar com outras pessoas com objetivos comuns para que a 
...
```
Por definição, interoperabilidade é a capacidade de sistemas diferentes 
trocarem e utilizarem entre si informações disponíveis e necessárias
```

A interoperabilidade acaba por ser uma condição crítica e necessária para a implantação e adoção tecnológica do BIM. Neste sentido, há atualmente uma tentativa de se estabelecer um padrão universal, conhecido como IFC ( Industry Foundation Classes), desenvolvido pela _buildingSMART - International Alliance for Interoperability_.
...
**COLOCAR IMAGEM DE IFC**


### algumas referência complementares

[IFC e Interoperabilidade BIM](https://www.e-zigurat.com/blog/pt-br/ifc-e-interoperabilidade-bim/)
